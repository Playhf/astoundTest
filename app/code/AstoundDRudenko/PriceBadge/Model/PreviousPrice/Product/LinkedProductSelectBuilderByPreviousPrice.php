...
namespace AstoundDRudenko\PriceBadge\Model\PreviousPrice\Product;
...
class LinkedProductSelectBuilderByPreviousPrice implements LinkedProductSelectBuilderInterface
{
    /**
    ...
    public function build($productId)
    {
        ...
        $previousPriceAttribute = $this->eavConfig->getAttribute(Product::ENTITY, Config::PREVIOUS_PRICE_ATTRIBUTE_CODE);
        ...
        $priceSelect = $this->resource->getConnection()->select()
            ...
            ->joinInner(
                ...
                ['t' => $previousPriceAttribute->getBackendTable()],
                sprintf('t.%s = %s.%1$s', $linkField, BaseSelectProcessorInterface::PRODUCT_TABLE_ALIAS),
                []
            )->where('parent.entity_id = ?', $productId)
            ->where('t.attribute_id = ?', $previousPriceAttribute->getAttributeId())
